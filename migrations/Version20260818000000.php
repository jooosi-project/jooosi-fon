...
final class Version20260818000000 extends AbstractMigration
{
    ...
    public function up(): void
    {
        ...
        $statements = [
            "ALTER TABLE `{$table}` MODIFY `metadata` MEDIUMTEXT NULL, MODIFY `font_faces` MEDIUMTEXT NULL",
        ];
        $indexes = [
            'jooosi_fon_deleted_status' => '`deleted_at`, `status`',
            'jooosi_fon_type_deleted' => '`type`, `deleted_at`',
            'jooosi_fon_slug' => '`slug`(191)',
        ];
