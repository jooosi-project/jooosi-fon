 ...
 */
namespace JooosiFonDeps\Symfony\Component\String;

use JooosiFonDeps\Symfony\Component\String\Exception\ExceptionInterface;
use JooosiFonDeps\Symfony\Component\String\Exception\InvalidArgumentException;
use JooosiFonDeps\Symfony\Component\String\Exception\RuntimeException;
/**
...
abstract class AbstractUnicodeString extends AbstractString
{
    ...
    {
        $str = clone $this;
        if (!$compat || \PHP_VERSION_ID < 70300 || !\defined('JooosiFonDeps\Normalizer::NFKC_CF')) {
