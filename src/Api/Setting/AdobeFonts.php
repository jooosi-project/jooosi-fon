...
class AdobeFonts extends AbstractApi implements ApiInterface
{
            ...
            [
                ...
                'args' => [
                    'project_id' => [
                        ...
                        'validate_callback' => [RequestValidator::class, 'projectId'],
                    ],
                ],
            ]
        );
        ...
        register_rest_route(
            ...
            [
                ...
                'args' => [
                    'kit' => [
                        'required' => true,
                        'validate_callback' => [RequestValidator::class, 'adobeKit'],
                    ],
                ],
            ]
        );
    ...
    public function get_kits(WP_REST_Request $wprestRequest): WP_REST_Response
    {
        ...
        $response = wp_safe_remote_get(sprintf(
            'https://typekit.com/api/v1/json/kits/%s/published',
        ...
        try {
            ...
            return new WP_REST_Response([
                'message' => __('Adobe Fonts returned an invalid response.', 'jooosi-fon'),
            ], 502);
        }
    ...
    public function sync(WP_REST_Request $wprestRequest): WP_REST_Response
    {
        ...
        try {
            ...
            return new WP_REST_Response([
                'message' => __('Adobe Fonts could not be synchronized. The previous data was preserved.', 'jooosi-fon'),
            ], 500);
        }
    ...
    public function destroy(WP_REST_Request $wprestRequest): WP_REST_Response
    {
        try {
            ...
            return new WP_REST_Response([
                'message' => __('Adobe Fonts could not be disconnected.', 'jooosi-fon'),
            ], 500);
        }
