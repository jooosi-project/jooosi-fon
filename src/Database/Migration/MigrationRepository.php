...
final class MigrationRepository
{
    ...
    public function __construct(MigrationConfiguration $configuration, MigrationRegistry $registry)
    {
    ...
    public function versions(): array
    {
        ...
        foreach ($this->metadata() as $metadata) {
            ...
            $versions[$version] = [
                'version' => $version,
                'executed' => true,
                'executed_at' => isset($metadata['executed_at']) ? (string) $metadata['executed_at'] : null,
                'execution_time' => isset($metadata['execution_time']) ? (int) $metadata['execution_time'] : null,
            ];
        }
    ...
    public function recordExecution(MigrationDefinition $definition, int $executionTime): void
    {
        global $wpdb;
        ...
        $inserted = $wpdb->insert(
            ...
            [
                ...
                'execution_time' => max(0, $executionTime),
            ],
            ['%s', '%s', '%d']
        );
