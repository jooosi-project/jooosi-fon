...
final class MigrationManager
{
    ...
    {
        $this->configuration = new MigrationConfiguration($configuration);
        $this->registry = new MigrationRegistry($this->configuration);
        $this->repository = new MigrationRepository($this->configuration, $this->registry);
    ...
    public function boot(): void
    {
        ...
        if (class_exists('WP_CLI')) {
            \WP_CLI::add_command($this->configuration->commandNamespace(), new MigrationCommand($this));
        }
    }
