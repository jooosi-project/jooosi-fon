...
final class Frontpage
{
    ...
    {
        if (defined('JOOOSI_FON_CSS_CACHE_WAS_LOADED')) {
            return;
        }
        ...
        define('JOOOSI_FON_CSS_CACHE_WAS_LOADED', true);
    ...
    {
        if (defined('JOOOSI_FON_PRELOAD_HTML_WAS_LOADED') && ! $this->print_preload_resources) {
            return $resources;
        }

        if (! defined('JOOOSI_FON_PRELOAD_HTML_WAS_LOADED')) {
            Debug::stopwatch()->start(sprintf('%s::%s', self::class, __FUNCTION__));
            ...
            define('JOOOSI_FON_PRELOAD_HTML_WAS_LOADED', true);
