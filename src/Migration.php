...
final class Migration
{
    ...
    public function __construct()
    {
        ...
        $this->migrationManager = new MigrationManager([
            ...
            'basePath' => dirname(JOOOSI_FON::FILE),
            'commandNamespace' => 'jooosi-fon migrations',
        ]);
    ...
    private function upgradeLegacyMigrationHistory(): void
    {
        ...
        (new MigrationHistoryUpgrader())->upgrade(
            self::LEGACY_MIGRATION_TABLE,
            self::MIGRATION_TABLE,
            'Yabe\\Webfont\\Migrations\\',
            'JooosiFon\\Migrations\\'
        );
