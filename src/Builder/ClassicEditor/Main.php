...
namespace JooosiFon\Builder\ClassicEditor;
...
class Main implements BuilderInterface
{
    ...
    public function filter_tiny_mce($mceInit, $editor_id)
    {
        ...
        foreach ($fonts as $font) {
            $theme_advanced_fonts .= sprintf('[Jooosi Fon] %s=%s;', $font['title'], $font['family']);
        }
    ...
    {
        $css_url = Cache::get_versioned_cache_url(Cache::CSS_CACHE_FILE);
