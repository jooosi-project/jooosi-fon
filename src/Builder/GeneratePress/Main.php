...
namespace JooosiFon\Builder\GeneratePress;
...
class Main implements BuilderInterface
{
    ...
    {
        $fonts = Font::get_fonts();
        $jooosi_fonts = array_map(static fn($f) => ['label' => $f['title'], 'value' => $f['family']], $fonts);
        return array_merge([['label' => 'Jooosi Fon', 'options' => $jooosi_fonts]], is_array($gb_fonts) ? $gb_fonts : iterator_to_array($gb_fonts));
    }
