...
class Main implements BuilderInterface
{
    public function __construct()
    {
         ...
         */
        if (Config::get('builder_integrations.disable_google_fonts.bricks', \true)) {
            add_filter('bricks/assets/load_webfonts', '__return_false', 1000001);
        }
        /**
        ...
        add_action('admin_menu', static fn() => AdminPage::add_redirect_submenu_page('bricks'), 1000001);
