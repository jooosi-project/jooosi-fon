...
class Main implements BuilderInterface
{
    ...
    public function register_block_editor_assets()
    {
        if (wp_script_is('kadence-blocks-js', 'registered')) {
            ...
            wp_enqueue_script('jooosi-fon-for-kadence-blocks', plugin_dir_url(__FILE__) . 'assets/script/kadence-blocks.js', ['kadence-blocks-js'], JOOOSI_FON::VERSION, true);
            wp_localize_script('jooosi-fon-for-kadence-blocks', 'jooosiFonKadenceBlocks', [
                'fonts' => $jooosi_fonts,
            ]);
        }
    }
