...
class Main implements BuilderInterface
{
    public function __construct()
    {
        ...
        add_action('yp_editor_header', fn() => $this->editor_header(), 1000001);
        add_action('admin_menu', static fn() => AdminPage::add_redirect_submenu_page('yellow-pencil-changes'), 1000001);
    }
    ...
    public function editor_header()
    {
        ...
        foreach ($fonts as $font) {
            $jooosi_fonts[] = ['value' => $font['family'], 'label' => $font['title'], 'category' => 'Jooosi Fon'];
        }
