            ...
            foreach ($result as $row) {
                $f = [
                    ...
                    'css' => [
                        ...
                        'legacy_custom_property' => self::legacy_css_custom_property($row->family),
                ...
                foreach ($font_faces as $font_face) {
                    if (property_exists($font_face, 'isEnabled')
                        && filter_var($font_face->isEnabled, FILTER_VALIDATE_BOOLEAN) !== true) {
                        continue;
                    }
