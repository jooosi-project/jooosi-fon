 ...
 */
if (! class_exists('YABE_WEBFONT', false)) {
    class_alias(JOOOSI_FON::class, 'YABE_WEBFONT');
}
 ...
 * @todo Remove this legacy class alias completely in Jooosi Fon 3.0.0.
 */
if (! class_exists('Yabe\Webfont\Utils\Font', false)) {
    class_alias(\JooosiFon\Utils\Font::class, 'Yabe\Webfont\Utils\Font');
}
